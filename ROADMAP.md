...
| 6 | Multiple users, permissions, and audit history | Partially complete (unreleased) | Administrator, editor, and viewer roles with account management are done; change history is still planned. |
