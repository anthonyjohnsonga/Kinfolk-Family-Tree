...
The current stable release is `v0.0.10`. Do not create a new stable tag until every required release gate below passes on a clean Docker host.
...
gh attestation verify \
  oci://ghcr.io/anthonyjohnsonga/kinfolk-family-tree-web:0.0.10 \
  -R anthonyjohnsonga/Kinfolk-Family-Tree

gh attestation verify \
  oci://ghcr.io/anthonyjohnsonga/kinfolk-family-tree-api:0.0.10 \
  -R anthonyjohnsonga/Kinfolk-Family-Tree

gh attestation verify \
  oci://ghcr.io/anthonyjohnsonga/kinfolk-family-tree-migrate:0.0.10 \
  -R anthonyjohnsonga/Kinfolk-Family-Tree
```
